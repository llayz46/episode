        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    ...
                    l’accès à votre compte si vous perdez votre appareil 2FA.
                    Conservez-les dans un gestionnaire de mots de passe sûr.
                </CardDescription>
            </CardHeader>
            <CardContent>
                            ...
                            <>
                                ...
                                <div className="text-xs text-muted-foreground select-none">
                                    <p id="regenerate-warning">
                                        ...
                                        supprimé après utilisation. Si vous en
                                        avez besoin de nouveaux, cliquez sur{' '}
