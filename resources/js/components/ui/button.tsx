  ...
  "relative inline-flex shrink-0 cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-lg border font-medium text-base outline-none transition-all active:not-aria-[haspopup]:translate-y-px before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-lg)-1px)] pointer-coarse:after:absolute pointer-coarse:after:size-full pointer-coarse:after:min-h-11 pointer-coarse:after:min-w-11 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-64 data-loading:select-none data-loading:text-transparent sm:text-sm [&_svg:not([class*='opacity-'])]:opacity-80 [&_svg:not([class*='size-'])]:size-4.5 sm:[&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:-mx-0.5 [&_svg]:shrink-0",
  {
    ...
    variants: {
      ...
      variant: {
        ...
        glass:
          "border-white/10 bg-white/10 text-white shadow-xs/5 backdrop-blur-sm not-disabled:inset-shadow-[0_1px_--theme(--color-white/10%)] hover:bg-white/16 data-pressed:bg-white/16 *:data-[slot=button-loading-indicator]:text-white dark:border-white/10 dark:bg-white/10 dark:text-white dark:hover:bg-white/16 dark:data-pressed:bg-white/16 dark:not-disabled:inset-shadow-[0_1px_--theme(--color-white/8%)] [:disabled,:active,[data-pressed]]:shadow-none",
        ...
        secondary:
          "border-input bg-foreground/8 not-dark:bg-clip-padding text-foreground shadow-xs/5 not-disabled:inset-shadow-[0_1px_--theme(--color-white/48%)] not-disabled:not-active:not-data-pressed:before:shadow-[0_1px_--theme(--color-black/4%)] hover:bg-foreground/12 data-pressed:bg-foreground/12 *:data-[slot=button-loading-indicator]:text-foreground dark:bg-foreground/12 dark:data-pressed:bg-foreground/16 dark:hover:bg-foreground/16 dark:not-disabled:inset-shadow-[0_1px_--theme(--color-white/14%)] dark:not-disabled:before:shadow-[0_-1px_--theme(--color-white/2%)] dark:not-disabled:not-active:not-data-pressed:before:shadow-[0_-1px_--theme(--color-white/6%)] [:disabled,:active,[data-pressed]]:shadow-none",
      },
    },
  },
);
