        ...
        <main className="dark relative isolate min-h-screen overflow-hidden bg-neutral-950 text-white">
            ...
            <div className="mx-auto w-full max-w-[1600px] px-5 py-6 sm:px-8 lg:px-12 lg:py-8">
                ...
                <section className="mt-8 grid gap-8 lg:grid-cols-[14rem_minmax(0,1fr)_13rem] lg:items-center lg:gap-8">
                    ...
                    <div className="max-w-2xl">
                        ...
                        <div className="mt-7 flex flex-wrap gap-3">
                            <Button>
                                ...
                                />
                                {isSeries ? 'Commencer le suivi' : 'À regarder'}
                            </Button>
                    ...
                    <aside className="grid grid-cols-2 gap-x-6 gap-y-6 border-t border-white/10 pt-6 text-sm sm:grid-cols-3 lg:grid-cols-1 lg:border-t-0 lg:border-l lg:pt-0 lg:pl-7">
                        {media.rating && (
                            <div>
